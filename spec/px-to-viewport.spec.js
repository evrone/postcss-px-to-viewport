...
describe("unitToConvert", function () {
  ...
  it("should convert only values described in options", function () {
    var rules = ".rule { font-size: 5em; width: 10EM; line-height: 2px }";
    var expected =
      ".rule { font-size: 1.5625vw; width: 10EM; line-height: 2px }";
    var options = {
      unitToConvert: "em",
    };
    var processed = postcss(pxToViewport(options)).process(rules).css;
  ...
  it("should convert only values described in array options", function () {
    var rules = ".rule { font-size: 5em; width: 10EM; line-height: 2px }";
    var expected =
      ".rule { font-size: 1.5625vw; width: 3.125vw; line-height: 2px }";
    var options = {
      unitToConvert: ["em", "EM"],
    };
    var processed = postcss(pxToViewport(options)).process(rules).css;
